    ...
    public static void main(String[] args) {
        ...
        if (resultStr.equals("null1")){
            ...
            if (firstNumber == -1 | secondNumber == -1) {
                System.out.println("Ошибка, число не от 1 до 10!");
            } else {

                if (words.length != 3) {
                    System.out.println("В примере должно быть два числа!");
                    ...
                    if (RomanValue == 0) {
                        ...
                        try {
                            ...
                            System.out.println("В римской системе нет отрицательных числел!");
                        }
                    } else {
                        System.out.println("Должно быть одна система счисления!");
                    }
                }
            }
        }
